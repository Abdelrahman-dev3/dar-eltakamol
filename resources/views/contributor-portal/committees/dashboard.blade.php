            ...
            @if($nextMeeting)
                <div class="cp-news-item">
                    ...
                    <div class="cp-news-body">
                        <h3 class="cp-news-title"><a href="{{ route('contributor.committees.meetings.show', $nextMeeting) }}">{{ $nextMeeting->name }}</a></h3>
        ...
        <div class="cp-news-list compact">
            @forelse($latestMeetings as $meeting)
                <article class="cp-news-item">
                    <div class="cp-news-icon"><i class="bi bi-camera-video-fill"></i></div>
                    <div class="cp-news-body">
                        <h3 class="cp-news-title"><a href="{{ route('contributor.committees.meetings.show', $meeting) }}">{{ $meeting->name }}</a></h3>
                        <div class="cp-news-meta">
