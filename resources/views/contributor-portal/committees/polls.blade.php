@extends('layouts.app')
@section('title', __('استطلاعات اللجان'))
...
<div class="cp-page">
    <section class="cp-hero">
        <div>
            <h1 class="cp-title">{{ __('استطلاعات اللجان') }}</h1>
            <p class="cp-subtitle">{{ __('الاستطلاعات الموجهة لك بصفتك عضوا في إحدى اللجان.') }}</p>
        </div>
        ...
        <div class="cp-table-wrap">
            <table class="cp-table">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td class="cp-empty" colspan="7">{{ __('لا توجد استطلاعات لجان موجهة لك حاليا') }}</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
