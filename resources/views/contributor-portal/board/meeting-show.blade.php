...
<div class="cp-page">
    <section class="cp-hero">
        ...
        <div class="cp-actions">
            ...
            @endif
            <a class="cp-btn cp-btn-secondary" href="{{ route('contributor.board.meetings') }}"><i class="bi bi-arrow-right"></i>{{ __('رجوع للاجتماعات') }}</a>
        </div>
    </section>
        ...
        <div class="cp-news-list">
            @forelse($meeting->attachments as $attachment)
                <article class="cp-news-item">
                    ...
                    <div class="cp-actions">
                        <a class="cp-btn cp-btn-primary" href="{{ route('contributor.board.meetings.attachments.view', [$meeting, $attachment]) }}" target="_blank" rel="noopener"><i class="bi bi-eye-fill"></i>{{ __('عرض') }}</a>
                        <a class="cp-btn cp-btn-secondary" href="{{ route('contributor.board.meetings.attachments.download', [$meeting, $attachment]) }}"><i class="bi bi-download"></i>{{ __('تحميل') }}</a>
                    </div>
                </article>
            @empty
